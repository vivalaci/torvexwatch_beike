...
return [
    ...
    'products_upload_new'    => 'Upload new',
    'file_manager_select'    => 'Select existing',
    ...
    'image_help'             => 'The first image will serve as the main product image. You can upload local images by dragging and dropping, and you can freely reorder multiple images.',
    ...
    'sku_hint'               => 'Note: It is recommended that the number of SKUs should not exceed 100. More SKUs may cause page freezes, longer rendering times, or truncation of submitted data due to excessive size.',
    'view_more'              => 'Preview',
    'images_video'           => 'images/video',
    'add_url'                => 'add url',
    'add_url_help'      => 'Only supports YouTube videos and remote video links in MP4 format',
    'full_edit'      => 'Full screen edit',
];
