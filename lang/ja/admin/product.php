...
return [
    ...
    'iframe_code'            => 'Iframe組み込みコードです',
    'iframe_code_hint'       => 'youtubeのようなビデオサイト埋め込みコードをクリックしますIframe更にクリックしますビデオサイト埋め込みコード、復制中のコード',
    'image_help'             => '最初の画像は商品メイン画像として使用されます。ローカル画像はドラッグ＆ドロップでアップロードでき、複数の画像を自由に順番変更できます。',
    'model'                  => 'モデル',
    ...
    'products_filter_index'  => '上位スクリーニングをチェックします',
    'products_filter_update' => '上位スクリーニングを修正します',
    ...
    'quantity'               => '数量',
    'stocks'                 => '商品在庫',
    'video_help'             => 'システムサイズの制限を超える場合は、php.iniパラメータpost_max_sizeを変更します。',
    'video_local'            => '地元です',
    'video_path'             => 'ビデオアドレスです',
    'video_path_hint'        => 'リモートビデオは。mp4で終わるアドレスが必要です',
    'weight_class'           => '重量単位',
    'weight_text'            => '重さ',
];
