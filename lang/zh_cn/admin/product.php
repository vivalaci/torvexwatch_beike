...
return [
    ...
    'products_upload_new'    => '上传新图片',
    'file_manager_select'    => '从图片库选择',
    'drag_drop_upload'    => '拖放图片上传',
    ...
    'image_help'             => '第一张图片将作为商品主图, 本地图片可拖拽上传，多张图片之间可随意调整位置',
    ...
    'sku_hint'               => '注意：多规格建议不超过100个，更多可能会导致页面卡顿、渲染时间变长、提交数据过大被截断的问题',
    'view_more'              => '预览',
    'images_video'      => '图片/视频',
    'add_url'      => '添加 URL',
    'add_url_help'      => '只支持 YouTube 视频 和 mp4 格式的远程视频链接',
    'full_edit'      => '全屏编辑',
];
