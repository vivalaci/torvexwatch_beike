          ...
          <div class="table-push">
            <table class="table table-hover">
              ...
              @foreach ($products_format as $product)
                <tr class="cursor-pointer row-link" data-to-url="{{ admin_route('products.edit', [$product['id'], http_build_query(request()->query())]) }}">
                  ...
                  <td>
                    <el-tooltip class="item" effect="light" placement="right" popper-class="product-image-tooltip">
                      <div slot="content" class="w-max-300">
                        <a href="{{ admin_route('products.edit', [$product['id'], http_build_query(request()->query())]) }}"><img src="{{ $product['images'][0] ?? system_setting('base.placeholder') ?? 'image/placeholder.png' }}" class="img-fluid max-h-100"></a>
                      </div>
