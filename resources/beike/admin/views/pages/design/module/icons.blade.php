<template id="module-editor-icons-template">
  <div class="image-edit-wrapper">
    ...
    <div class="module-edit-group">
      <el-checkbox v-model="form.lux_icons_carousel">{{ __('admin/builder.lux_icons_carousel') }}</el-checkbox>
    </div>
...
Vue.component('module-editor-icons', {
  ...
  created: function () {
    ...
    if (typeof this.form.lux_icons_carousel === 'undefined') {
      this.$set(this.form, 'lux_icons_carousel', false);
    }
  },
