      ...
      >
        <div class="pb-images-selector" v-for="(item, index) in module.images" :key="index">
          ...
          <div :class="'pb-images-list ' + (item.show ? 'active' : '')">
            ...
            <link-selector v-model="item.link" :is-custom-name="true" style="margin-bottom: 10px"></link-selector>

            <div class="module-edit-title">{{ __('admin/builder.second_link_optional') }}</div>
            <link-selector v-model="item.link_2" :is-custom-name="true" style="margin-bottom: 10px"></link-selector>
  ...
  methods: {
    ...
    addImage() {
      ...
      this.module.images.push({
        image: {
          src: 'image/catalog/demo/banner/text-image-banner-1.jpg',
          alt: languagesFill(''),
        },
        show: true,
        ...
        link_2: {type: '', value: '', text: languagesFill('')}
      });
    }
  }
});
  ...
  <script>
    ...
    register.make = {
      ...
      images: [
        ...
        {
          image: {
            src: 'image/catalog/demo/banner/text-image-banner-2.jpg',
            alt: languagesFill(''),
          },
          show: false,
          sub_title: languagesFill(''),
