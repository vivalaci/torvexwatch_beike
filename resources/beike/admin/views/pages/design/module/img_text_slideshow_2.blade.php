<template id="module-editor-img-text-slideshow-2-template">
  <div>
...
Vue.component('module-editor-img-text-slideshow-2', {
  template: '#module-editor-img-text-slideshow-2-template',
...
@push('footer-script')
  <script>
    ...
    register.make = {
      ...
      scroll_text: {
        text: languagesFill('Fashion Gala: Up to 80% Off!'),
        bg: '#ffffff',
        color: '#333333',
        font_size: '14',
        padding: '20'
