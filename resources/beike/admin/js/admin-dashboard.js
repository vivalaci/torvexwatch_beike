...
class EnhancedDashboard {
  ...
  async loadStatsData(timeRange) {
    try {
      const response = await fetch(`${window.dashboardRoutes.stats}?time_range=${timeRange}`);
  ...
  async loadMiniChartData(timeRange) {
    try {
      ...
      const response = await fetch(`${window.dashboardRoutes.miniCharts}?time_range=${timeRange}`);
      const result = await response.json();
  ...
  async loadTrendData(timeRange) {
    try {
      const response = await fetch(`${window.dashboardRoutes.trends}?time_range=${timeRange}`);
      const result = await response.json();
  ...
  async loadSourceData(timeRange = 'today') {
    try {
      const response = await fetch(`${window.dashboardRoutes.source}?time_range=${timeRange}`);
      const result = await response.json();
  ...
  async loadFunnelData(timeRange) {
    try {
      const response = await fetch(`${window.dashboardRoutes.funnel}?time_range=${timeRange}`);
      const result = await response.json();
  ...
  async loadProductRanking(timeRange) {
    try {
      const [hotResponse, slowResponse] = await Promise.all([
        fetch(`${window.dashboardRoutes.products.hot}?time_range=${timeRange}`),
        fetch(`${window.dashboardRoutes.products.slow}?time_range=${timeRange}`)
      ]);
